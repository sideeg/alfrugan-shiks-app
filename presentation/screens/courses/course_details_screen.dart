                    ...
                    return SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (ctx, i) {
                          ...
                          return _GroupCard(
                            group: groups[i - 1],
                            course: course, // FIX: pass full entity
                            isDark: isDark,
                            accent: accent,
                          );
                        },
        ...
        background: Stack(children: [
          ...
          Positioned(
              ...
              child: CustomPaint(
                  ...
                  painter:
                      _StarWatermark(color: _dGold.withValues(alpha: 0.06)))),
          Positioned(
              left: -20,
              bottom: 20,
              child: CustomPaint(
                  ...
                  painter:
                      _StarWatermark(color: accent.withValues(alpha: 0.08)))),
          SafeArea(
              child: Padding(
...
class _GroupCard extends StatefulWidget {
  final dynamic group;
  final CourseEntity course; // FIX: typed, reliable courseId source
  final bool isDark;
  final Color accent;
  const _GroupCard(
      {required this.group,
...
class _GroupCardState extends State<_GroupCard>
  ...
  late final Animation<double> _turn, _size;
            ...
            child:
              ...
              Row(textDirection: TextDirection.rtl, children: [
                ...
                Container(
                    ...
                    child: Text('${g.currentStudents ?? 0}',
                        style: const TextStyle(
                            fontSize: 13,
                            fontWeight: FontWeight.bold,
                            color: _dGold))),
              ...
              Row(
                  ...
                  children: [
                    ...
                    Text('${g.currentStudents ?? 0}/${g.maxStudents ?? 0} طالب',
            ...
            child: Column(children: [
              ...
              if (students.isEmpty)
                ...
                ...List.generate(
                    ...
                    (i) => _StudentTile(
                          student: students[i],
                          groupId: (widget.group.id ?? 1) as int,
                          courseId:
                              widget.course.id, // ← reliable: from CourseEntity
                          isDark: isDark,
...
class _StudentTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        // FIX 1: context.push() instead of goNamed() — reliable inside shell
        // FIX 2: courseId comes from CourseEntity.id (int), not dynamic field guess
        // FIX 3: studentName URL-encoded so special chars don't break the route
        onTap: () {
          final sid = (s.id ?? 0).toString();
          final sname = Uri.encodeComponent((s.name ?? 'طالب').toString());
          context.push(
            '/student-logs/$sid/$sname',
            extra: {'courseId': courseId, 'groupId': groupId},
          );
        },
        borderRadius: isLast
